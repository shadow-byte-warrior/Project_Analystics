...
> ### *"Turning thousands of raw job postings into four career-defining answers — powered entirely by Excel."*
...
<details>
<summary><b>🔍 &nbsp;EXTRACT → TRANSFORM → LOAD — view the ETL process</b></summary>
<br/>
...
| Step | Action |
|:---:|---|
| **1️⃣** | Download [`1_Project_Analysis.xlsx`](https://github.com/shadow-byte-warrior/Project_Analystics/blob/main/1_Project_Analysis.xlsx) |
